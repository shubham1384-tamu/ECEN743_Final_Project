...
"""
    ...
    def _sanitize_tune_output(self, text: str) -> tuple:
        """
        Extract MPC parameters from LLM output (supports both XML-wrapped and plain dict formats).
        
        Expected formats:
        1. XML format (trained output):
           <reasoning>...</reasoning>
           <answer>
           new_mpc_params = {'param1': val1, 'param2': val2}
           </answer>
        ...
        try:
            ...
            if match:
                ...
                try:
                    # Handle multi-line dictionaries by normalizing whitespace
